                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 bg-white border-b border-gray-200">
                            ...
                            <div className="mb-4">
                                ...
                                <input value={data.name} onChange={e => setData('name', e.target.value)} type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded w-full p-2" />
                            </div>
                            <div className="mb-4">
                                <button type="button" onClick={sendSection} className="mr-2 rounded border border-transparent shadow-sm px-2 py-1 bg-green-600 text-base font-medium text-white">Saqlash</button>
                            </div>
                        </div>
                    </div>
                </div>
